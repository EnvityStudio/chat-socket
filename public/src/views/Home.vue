        ...
        <div class="row content">
            ...
            <div class="col-sm-9 position-absolute conversation">
                <div id="content-group" class="content-group position-fixed">
                    <img src="../assets/icon_group.png"
                         alt="icon-group"
                         class="icon-group" />
                    <span>ROOM NAME</span>
                    <hr/>
                </div>
                <div id="scrollbar-list-conversation"

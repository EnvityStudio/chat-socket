    ...
    <nav class="navbar navbar-inverse no-margin-bottom">
      <div class="container-fluid">
        <div class="navbar-header col-sm-3 navbar-left">
          ...
          <a class="navbar-brand" href="#" target="__blank">
            <img src="../../assets/icon_search.png" alt="logo" />
          </a>
        </div>
          ...
          <ul class="nav navbar-nav navbar-left no-padding-start">
            <li>
              <input
                ...
                name="search"
                class="searchBox"
                placeholder="Tìm kiếm tên cuộc trò chuyện"
              />
        ...
        <div
          class="collapse navbar-collapse col-sm-6 navbar-right"
          id="myNavbar"
        >
          <ul class="nav navbar-right nav-color-icon">
            <li>
                  ...
                  <div id="notifications">
                    ...
                    <div class="noti_content">
                      <span data-uid="${ user.id }">
                        <img class="avatar-small" src="" alt="" />
                        <strong>Thuan Envity</strong> đã chấp nhận lời mời kết
                        bạn của bạn! </span
                      ><br /><br /><br />

                      <span data-uid="${ user.id }">
                        <img class="avatar-small" src="" alt="" />
                        <strong>Thuan Envity</strong> đã gửi cho bạn một lời mời
                        kết bạn! </span
                      ><br /><br /><br />
                    </div>
